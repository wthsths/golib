...
func (sr *Router) FindMatch(r *http.Request) (routeTo func(w http.ResponseWriter, r *http.Request, sessionID string, routeParams map[string]string), requiresAuth bool, routeParams map[string]string) {
